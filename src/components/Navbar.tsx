        ...
        <div className="flex justify-between h-16">
          <div className="flex">
            ...
            <div className="hidden sm:ml-6 sm:flex sm:space-x-8">
              ...
              <Link to="/products" className="border-transparent text-gray-500 hover:border-laundry-500 hover:text-laundry-700 inline-flex items-center px-1 pt-1 border-b-2 text-sm font-medium">
          ...
          <div className="-mr-2 flex items-center sm:hidden">
            <button
              onClick={toggleMenu}
              className="inline-flex items-center justify-center p-2 rounded-md text-gray-400 hover:text-gray-500 hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-inset focus:ring-laundry-500"
            >

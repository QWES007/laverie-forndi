...
export const calculerDonneesGraphiques = (commandes: Commande[]) => {
  ...
  const forfaitsData = [
    { forfait: "Premium", commandes: 0 },
    { forfait: "Standard", commandes: 0 },
    { forfait: "Eco", commandes: 0 },
    { forfait: "Express", commandes: 0 },
    { forfait: "Famille", commandes: 0 },
  ];
  ...
  // Quantité de linge
  const quantiteLinge = [
    { semaine: "Sem 1", quantite: 0 },
    { semaine: "Sem 2", quantite: 0 },
    { semaine: "Sem 3", quantite: 0 },
    { semaine: "Sem 4", quantite: 0 },
  ];
